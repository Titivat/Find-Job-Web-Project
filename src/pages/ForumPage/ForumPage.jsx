...
function ForumPage(props) {
  let count = 0;
  const apiApth = "https://grumpy-otter-68.loca.lt";
    ...
    <div>
      ...
      <div className="forum-page-container">
        ...
        <div className="forum-page-input-section">
          <ProfileIcon radius={"50%"} size={["78px", "78px"]} />

          <button onClick={() => togglePopup()} className="forum-page-button">
        ...
        <div className="forum-content-container">
            ...
            return (
              <div className="forum-contnet-item">
                <Forum
                  ...
                  backgroundColor={
                    index % 3 === 0
                      ? defineColour((count = 0))
                      : defineColour((count += 1))
                  }
                />
              </div>
            );
          ...
          <div className="forum-contnet-item">{/*dummy item*/}</div>
        </div>
      </div>
