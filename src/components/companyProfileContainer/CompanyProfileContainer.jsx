        ...
        return (
            <div className="companyProfileContainer">
                ...
                <div className="rowContainer">
                    ...
                    <span className="comfortaa mediumSize white" id="companyText">{companyName}</span>
                </div>
                <div className="rowContainer">
                    <span className="comfortaa mediumSize label">Email:</span>
                    <span className="comfortaa mediumSize white" id="companyText">{email}</span>
                </div>
                <button id="editProfileButton" className="comfortaa">edit profile</button>
            </div>
        );
    }
}
